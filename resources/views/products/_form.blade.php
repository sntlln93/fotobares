...
<table class="table table-responsive table-bordered">
    ...
    <tbody>
        ...
        <tr>
            <td>
                <input class="form-control @error('quotas[{{ $loop->index }}][quantity]') is-invalid @enderror"
                    type="number" readonly value="{{ $loop->iteration }}" name="quotas[{{ $loop->index }}][quantity]">
            </td>
            <td>
                <input type="number"
        ...
        <tr>
            <td>
                <input class="form-control @error('quotas[0][quantity]') is-invalid @enderror" type="number" readonly
                    value="{{ $product->name }}" name="quotas[0][quantity]">
            </td>
            <td>
